...
echo "GIT_DIRECTORY_PATH: $GIT_DIRECTORY_PATH"
echo "DOTNET_APP_SOLUTION_OR_PROJECT_FILE_PATH: $DOTNET_APP_SOLUTION_OR_PROJECT_FILE_PATH"
echo "DOTNET_APP_NUGET_PACKAGES_ACCESS_TOKEN_MYGET: $DOTNET_APP_NUGET_PACKAGES_ACCESS_TOKEN_MYGET"
echo "DOTNET_APP_NUGET_PACKAGES_ACCESS_TOKEN_NUGET: $DOTNET_APP_NUGET_PACKAGES_ACCESS_TOKEN_NUGET"
